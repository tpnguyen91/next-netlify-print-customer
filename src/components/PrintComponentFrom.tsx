  ...
  return (
    <div className="border">
      <div
        ...
        //@ts-ignore
        ref={ref}>
        <div className="grid grid-cols-[110px_1fr] w-full border-dashed	border-2 px-1 py-1 rounded">
        ...
        <div className="grid grid-cols-[110px_1fr] w-full border-dashed	border-2 px-1 py-1 rounded mt-2">
          <div className="w-[100px] underline">Người nhận:</div>
          <div className="">
            <div>
              <p className="font-bold text-[50px]">{name}</p>
              <p className="font-medium text-[20px]">{phone}</p>
            </div>
